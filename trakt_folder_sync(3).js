(function () {
    ...
    // Флаг подавления: когда мы сами меняем Lampa из Trakt, не дублируем в Trakt
    ...
    function init() {
        // Lampa.Favorite.listener генерирует события 'add' и 'remove'
        // с полями { where: 'book'/'thrown'/..., card: {...} }
